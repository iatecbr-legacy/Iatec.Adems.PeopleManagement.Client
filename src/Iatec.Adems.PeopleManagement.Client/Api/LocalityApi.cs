...
namespace Iatec.Adems.PeopleManagement.Client.Api
{
    ...
    public interface ILocalityApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;LocalityLiteModel&gt;</returns>
        List<LocalityLiteModel> GetListLocalityForUpdate(bool onlyInUse, DateTime? updateDate = null);
        ...
        /// <param name="updateDate"> (optional)</param>
        /// <param name="onlyInUse"> </param>        
        /// <returns>ApiResponse (List&lt;LocalityLiteModel&gt;)</returns>
        ApiResponse<List<LocalityLiteModel>> GetListLocalityForUpdateHttpInfo(bool onlyInUse, DateTime? updateDate = null);
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>Task of ApiResponse (List&lt;LocalityLiteModel&gt;)</returns>
        System.Threading.Tasks.Task<List<LocalityLiteModel>> GetListLocalityForUpdateAsync(bool onlyInUse, DateTime? updateDate = null);
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>Task of ApiResponse (List&lt;LocalityLiteModel&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<LocalityLiteModel>>> GetListLocalityForUpdateAsyncHttpInfo(bool onlyInUse, DateTime? updateDate = null);
    ...
    public partial class LocalityApi : ILocalityApi
    {
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>List&lt;LocalityLiteModel&gt;</returns>
        public List<LocalityLiteModel> GetListLocalityForUpdate(bool onlyInUse, DateTime? updateDate = null)
        {
            ApiResponse<List<LocalityLiteModel>> localVarResponse = GetListLocalityForUpdateHttpInfo(onlyInUse, updateDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>ApiResponse (List&lt;LocalityLiteModel&gt;)</returns>
        public ApiResponse<List<LocalityLiteModel>> GetListLocalityForUpdateHttpInfo(bool onlyInUse, DateTime? updateDate = null)
        {
            var localVarPath = "/locality/forUpdate";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetListLocalityForUpdate", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>Task of List&lt;LocalityLiteModel&gt;</returns>
        public async System.Threading.Tasks.Task<List<LocalityLiteModel>> GetListLocalityForUpdateAsync(bool onlyInUse, DateTime? updateDate = null)
        {
            ApiResponse<List<LocalityLiteModel>> localVarResponse = await GetListLocalityForUpdateAsyncHttpInfo(onlyInUse, updateDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="onlyInUse"> </param>        
        /// <returns>Task of ApiResponse (List&lt;LocalityLiteModel&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<LocalityLiteModel>>> GetListLocalityForUpdateAsyncHttpInfo(bool onlyInUse, DateTime? updateDate = null)
        {
            var localVarPath = "/locality/forUpdate";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
